...
public class Exercises {
	...
	public boolean endsLy(String str) {
		...
		boolean fOrT = str.substring(str.length()-2,str.length()).equals("ly");
		return fOrT;
	}
	...
	public boolean doubleX(String str) {
		...
		if (xPos+2>str.length()) {
			return false;
		}
		if (str.substring(xPos +1,xPos+2).equals("x")) {
			return true;
		} else return false;
	}
	...
	public String stringBits(String str) {
		...
		for (int i = 0;i<str.length();i=i+2) {
			newWord = newWord + str.substring(i,i+1);
		}
		return newWord;
	}
	...
	public String stringSplosion(String str) {
		String sploded = "";
		for (int i =0;i<=str.length();i++) {
			sploded =sploded + str.substring(0,i);
		}
		return sploded;
	}
	...
	public int last2(String str) {
		...
		String last22 =str.substring(str.length() -2,str.length());
		int count = 0;
		for(int i =0;i+2<=str.length();i++) {
			if(str.substring(i,i+2).equals(last22)) {
				count ++;
			}
		} 
		return count -1;
	...
	public String stringX(String str) {
		...
		for(int i =0;i<middleOfString.length();i++) {
			if (middleOfString.substring(i,i+1).equals("x")) {
				continue;
			}
			output= output + middleOfString.substring(i,i+1);
		}
		return str.substring(0,1) + output +str.substring(str.length()-1,str.length());
	}
	...
	public String stringYak(String str) {
		...
		for(int i =0;i+3<=str.length();i++) {
			...
			return output;
		}else if(str.substring(str.length()-4,str.length()-1).equals("yak")){
			return output+ str.substring(str.length()-1,str.length());
		}else {
		return output + str.substring(str.length()-2,str.length()) ;
		}
	}
