...
function addAll(...num){
    ...
    return num.reduce( (currentSum, number) => {
...
/**
 * 
 * @param {[...arr]} arr an array of strings to have 
 */
...
function getFullAddressesOfProperties(addresses){
    return addresses.map(displayAddress);
}
/*
...
/**
 * 
 * @param {number[number[]]} numbersToSum 
 */

 function getSumOfSubArrayValues(numbersToSum) {
    let sum = 0;
